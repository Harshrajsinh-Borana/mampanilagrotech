        ...
        <div style={{maxWidth:1140,margin:"0 auto",padding:"10px 20px",display:"flex",alignItems:"center",justifyContent:"space-between"}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:12}} className="hidden md:flex">
            <button onClick={()=>setCart(c=>c+1)} style={{background:"none",border:"none",cursor:"pointer",position:"relative",padding:6}}>
              ...
              <button onClick={()=>go("contact")} style={{background:"rgba(255,255,255,.12)",color:"rgba(255,255,255,.7)",border:"1px solid rgba(255,255,255,.2)",borderRadius:999,padding:"9px 18px",fontSize:13,fontWeight:600,cursor:"pointer",letterSpacing:.3}}>
                🌱 Launching Soon
              </button>
          </div>
      ...
      <div id="home" style={{background:`linear-gradient(160deg,#0d2a1a 0%,#1a4a2e 40%,#2d7a4f 100%)`,padding:"80px 20px 100px",position:"relative",overflow:"hidden"}}>
        ...
        <div style={{maxWidth:1140,margin:"0 auto",display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(300px,1fr))",gap:56,alignItems:"center",position:"relative",zIndex:1}}>
          <FadeIn dir="left">
            ...
            <button onClick={()=>go("contact")} style={{background:"rgba(255,255,255,.1)",color:"white",border:"1px solid rgba(255,255,255,.3)",borderRadius:999,padding:"13px 28px",fontSize:14,fontWeight:600,cursor:"pointer"}}>
                Why Navjeev?
            </button>
            </div>
          ...
          <FadeIn dir="right" delay={0.15}>
            <div style={{background:"white",borderRadius:28,boxShadow:"0 32px 80px rgba(0,0,0,.35)",overflow:"hidden",maxWidth:400,margin:"0 auto"}}>
              ...
              <div style={{padding:24}}>
                ...
                {/* Coming Soon block */}
                <div style={{background:"linear-gradient(135deg,#fff8e1,#fff3cd)",border:"1px solid #ffe082",borderRadius:16,padding:"20px 16px",textAlign:"center",marginBottom:6}}>
                  <div style={{fontSize:28,marginBottom:6}}>🚀</div>
                  <div style={{fontWeight:800,fontSize:16,color:"#7c5c00",marginBottom:4}}>Launching Soon!</div>
                  <div style={{color:"#a07800",fontSize:13,lineHeight:1.6}}>Navjeev is on its way. Register your interest below and be the first to know when we go live.</div>
                </div>
                <button onClick={()=>{ document.getElementById("contact")?.scrollIntoView({behavior:"smooth"}); }} style={{background:grad,color:"white",border:"none",borderRadius:14,padding:"13px 0",width:"100%",fontWeight:700,fontSize:14,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",gap:8,marginTop:12}}>
                  <Mail size={15}/> Notify Me at Launch
                </button>
                <div style={{textAlign:"center",fontSize:11,color:"#ccc",marginTop:10}}>🌱 Drop us a message — mampanilagrotech@gmail.com</div>
              </div>
            </div>
          </FadeIn>
        </div>
